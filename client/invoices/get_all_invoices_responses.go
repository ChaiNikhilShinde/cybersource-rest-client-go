...
/*GetAllInvoicesOK handles this case with default header values.
...
/*GetAllInvoicesBadRequest handles this case with default header values.
...
/*GetAllInvoicesNotFound handles this case with default header values.
...
/*GetAllInvoicesDefault handles this case with default header values.
...
func (o *GetAllInvoicesOKBodyInvoicesItems0CustomerInformation) validateName(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("customerInformation"+"."+"name", "body", string(o.Name), 100); err != nil {
		return err
	}
