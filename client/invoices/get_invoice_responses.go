...
/*GetInvoiceDefault handles this case with default header values.
...
func (o *GetInvoiceOKBody) validateID(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("getInvoiceOK"+"."+"id", "body", string(o.ID), 26); err != nil {
		return err
	}
...
func (o *GetInvoiceOKBodyCustomerInformation) validateEmail(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("getInvoiceOK"+"."+"customerInformation"+"."+"email", "body", string(o.Email), 255); err != nil {
		return err
	}
...
func (o *GetInvoiceOKBodyCustomerInformation) validateName(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("getInvoiceOK"+"."+"customerInformation"+"."+"name", "body", string(o.Name), 100); err != nil {
		return err
	}
...
func (o *GetInvoiceOKBodyInvoiceHistoryItems0TransactionDetails) validateAmount(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("transactionDetails"+"."+"amount", "body", string(o.Amount), 19); err != nil {
		return err
	}
...
func (o *GetInvoiceOKBodyInvoiceInformation) validateDescription(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("getInvoiceOK"+"."+"invoiceInformation"+"."+"description", "body", string(o.Description), 2000); err != nil {
		return err
	}
...
func (o *GetInvoiceOKBodyOrderInformationAmountDetails) validateBalanceAmount(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("getInvoiceOK"+"."+"orderInformation"+"."+"amountDetails"+"."+"balanceAmount", "body", string(o.BalanceAmount), 12); err != nil {
		return err
	}
...
func (o *GetInvoiceOKBodyOrderInformationAmountDetails) validateCurrency(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("getInvoiceOK"+"."+"orderInformation"+"."+"amountDetails"+"."+"currency", "body", string(o.Currency), 3); err != nil {
		return err
	}
...
func (o *GetInvoiceOKBodyOrderInformationAmountDetails) validateDiscountAmount(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("getInvoiceOK"+"."+"orderInformation"+"."+"amountDetails"+"."+"discountAmount", "body", string(o.DiscountAmount), 15); err != nil {
		return err
	}
...
func (o *GetInvoiceOKBodyOrderInformationAmountDetails) validateTotalAmount(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("getInvoiceOK"+"."+"orderInformation"+"."+"amountDetails"+"."+"totalAmount", "body", string(o.TotalAmount), 19); err != nil {
		return err
	}
...
func (o *GetInvoiceOKBodyOrderInformationAmountDetailsFreight) validateAmount(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("getInvoiceOK"+"."+"orderInformation"+"."+"amountDetails"+"."+"freight"+"."+"amount", "body", string(o.Amount), 13); err != nil {
		return err
	}
...
func (o *GetInvoiceOKBodyOrderInformationAmountDetailsTaxDetails) validateAmount(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("getInvoiceOK"+"."+"orderInformation"+"."+"amountDetails"+"."+"taxDetails"+"."+"amount", "body", string(o.Amount), 13); err != nil {
		return err
	}
...
func (o *GetInvoiceOKBodyOrderInformationAmountDetailsTaxDetails) validateRate(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("getInvoiceOK"+"."+"orderInformation"+"."+"amountDetails"+"."+"taxDetails"+"."+"rate", "body", string(o.Rate), 6); err != nil {
		return err
	}
