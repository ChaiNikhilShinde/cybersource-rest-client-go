...
/*MitReversalCreated handles this case with default header values.
...
/*MitReversalBadRequest handles this case with default header values.
...
/*MitReversalBadGateway handles this case with default header values.
...
func (o *MitReversalCreatedBody) validateID(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("mitReversalCreated"+"."+"id", "body", string(o.ID), 26); err != nil {
		return err
	}
...
func (o *MitReversalCreatedBody) validateReconciliationID(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("mitReversalCreated"+"."+"reconciliationId", "body", string(o.ReconciliationID), 60); err != nil {
		return err
	}
...
func (o *MitReversalCreatedBodyAuthorizationInformation) validateApprovalCode(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("mitReversalCreated"+"."+"authorizationInformation"+"."+"approvalCode", "body", string(o.ApprovalCode), 6); err != nil {
		return err
	}
...
func (o *MitReversalCreatedBodyAuthorizationInformation) validateReasonCode(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("mitReversalCreated"+"."+"authorizationInformation"+"."+"reasonCode", "body", string(o.ReasonCode), 50); err != nil {
		return err
	}
...
func (o *MitReversalCreatedBodyAuthorizationInformation) validateReversalSubmitted(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("mitReversalCreated"+"."+"authorizationInformation"+"."+"reversalSubmitted", "body", string(o.ReversalSubmitted), 1); err != nil {
		return err
	}
...
func (o *MitReversalCreatedBodyClientReferenceInformation) validateCode(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("mitReversalCreated"+"."+"clientReferenceInformation"+"."+"code", "body", string(o.Code), 50); err != nil {
		return err
	}
...
func (o *MitReversalCreatedBodyClientReferenceInformation) validateSubmitLocalDateTime(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("mitReversalCreated"+"."+"clientReferenceInformation"+"."+"submitLocalDateTime", "body", string(o.SubmitLocalDateTime), 14); err != nil {
		return err
	}
...
func (o *MitReversalCreatedBodyIssuerInformation) validateResponseCode(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("mitReversalCreated"+"."+"issuerInformation"+"."+"responseCode", "body", string(o.ResponseCode), 6); err != nil {
		return err
	}
...
func (o *MitReversalCreatedBodyPointOfSaleInformationEmv) validateTags(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("mitReversalCreated"+"."+"pointOfSaleInformation"+"."+"emv"+"."+"tags", "body", string(o.Tags), 1998); err != nil {
		return err
	}
...
func (o *MitReversalCreatedBodyProcessorInformation) validateForwardedAcquirerCode(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("mitReversalCreated"+"."+"processorInformation"+"."+"forwardedAcquirerCode", "body", string(o.ForwardedAcquirerCode), 32); err != nil {
		return err
	}
...
func (o *MitReversalCreatedBodyProcessorInformation) validateMasterCardServiceCode(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("mitReversalCreated"+"."+"processorInformation"+"."+"masterCardServiceCode", "body", string(o.MasterCardServiceCode), 2); err != nil {
		return err
	}
...
func (o *MitReversalCreatedBodyProcessorInformation) validateMasterCardServiceReplyCode(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("mitReversalCreated"+"."+"processorInformation"+"."+"masterCardServiceReplyCode", "body", string(o.MasterCardServiceReplyCode), 1); err != nil {
		return err
	}
...
func (o *MitReversalCreatedBodyProcessorInformation) validateResponseCategoryCode(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("mitReversalCreated"+"."+"processorInformation"+"."+"responseCategoryCode", "body", string(o.ResponseCategoryCode), 32); err != nil {
		return err
	}
...
func (o *MitReversalCreatedBodyProcessorInformation) validateResponseCode(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("mitReversalCreated"+"."+"processorInformation"+"."+"responseCode", "body", string(o.ResponseCode), 10); err != nil {
		return err
	}
...
func (o *MitReversalCreatedBodyProcessorInformation) validateTransactionID(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("mitReversalCreated"+"."+"processorInformation"+"."+"transactionId", "body", string(o.TransactionID), 18); err != nil {
		return err
	}
...
func (o *MitReversalCreatedBodyReversalAmountDetails) validateCurrency(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("mitReversalCreated"+"."+"reversalAmountDetails"+"."+"currency", "body", string(o.Currency), 3); err != nil {
		return err
	}
...
func (o *MitReversalCreatedBodyReversalAmountDetails) validateOriginalTransactionAmount(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("mitReversalCreated"+"."+"reversalAmountDetails"+"."+"originalTransactionAmount", "body", string(o.OriginalTransactionAmount), 15); err != nil {
		return err
	}
...
func (o *MitReversalCreatedBodyReversalAmountDetails) validateReversedAmount(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("mitReversalCreated"+"."+"reversalAmountDetails"+"."+"reversedAmount", "body", string(o.ReversedAmount), 15); err != nil {
		return err
	}
...
func (o *MitReversalParamsBodyClientReferenceInformation) validateCode(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("mitReversalRequest"+"."+"clientReferenceInformation"+"."+"code", "body", string(o.Code), 50); err != nil {
		return err
	}
...
func (o *MitReversalParamsBodyClientReferenceInformation) validateTransactionID(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("mitReversalRequest"+"."+"clientReferenceInformation"+"."+"transactionId", "body", string(o.TransactionID), 30); err != nil {
		return err
	}
...
func (o *MitReversalParamsBodyClientReferenceInformationPartner) validateDeveloperID(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("mitReversalRequest"+"."+"clientReferenceInformation"+"."+"partner"+"."+"developerId", "body", string(o.DeveloperID), 8); err != nil {
		return err
	}
...
func (o *MitReversalParamsBodyClientReferenceInformationPartner) validateOriginalTransactionID(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("mitReversalRequest"+"."+"clientReferenceInformation"+"."+"partner"+"."+"originalTransactionId", "body", string(o.OriginalTransactionID), 32); err != nil {
		return err
	}
...
func (o *MitReversalParamsBodyClientReferenceInformationPartner) validateSolutionID(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("mitReversalRequest"+"."+"clientReferenceInformation"+"."+"partner"+"."+"solutionId", "body", string(o.SolutionID), 8); err != nil {
		return err
	}
...
func (o *MitReversalParamsBodyClientReferenceInformationPartner) validateThirdPartyCertificationNumber(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("mitReversalRequest"+"."+"clientReferenceInformation"+"."+"partner"+"."+"thirdPartyCertificationNumber", "body", string(o.ThirdPartyCertificationNumber), 12); err != nil {
		return err
	}
...
func (o *MitReversalParamsBodyOrderInformationAmountDetails) validateServiceFeeAmount(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("mitReversalRequest"+"."+"orderInformation"+"."+"amountDetails"+"."+"serviceFeeAmount", "body", string(o.ServiceFeeAmount), 15); err != nil {
		return err
	}
...
func (o *MitReversalParamsBodyPointOfSaleInformationEmv) validateTags(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("mitReversalRequest"+"."+"pointOfSaleInformation"+"."+"emv"+"."+"tags", "body", string(o.Tags), 1998); err != nil {
		return err
	}
...
func (o *MitReversalParamsBodyProcessingInformation) validateLinkID(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("mitReversalRequest"+"."+"processingInformation"+"."+"linkId", "body", string(o.LinkID), 26); err != nil {
		return err
	}
...
func (o *MitReversalParamsBodyProcessingInformation) validatePaymentSolution(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("mitReversalRequest"+"."+"processingInformation"+"."+"paymentSolution", "body", string(o.PaymentSolution), 12); err != nil {
		return err
	}
...
func (o *MitReversalParamsBodyProcessingInformation) validateReconciliationID(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("mitReversalRequest"+"."+"processingInformation"+"."+"reconciliationId", "body", string(o.ReconciliationID), 60); err != nil {
		return err
	}
...
func (o *MitReversalParamsBodyProcessingInformation) validateReportGroup(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("mitReversalRequest"+"."+"processingInformation"+"."+"reportGroup", "body", string(o.ReportGroup), 25); err != nil {
		return err
	}
...
func (o *MitReversalParamsBodyProcessingInformation) validateVisaCheckoutID(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("mitReversalRequest"+"."+"processingInformation"+"."+"visaCheckoutId", "body", string(o.VisaCheckoutID), 48); err != nil {
		return err
	}
...
func (o *MitReversalParamsBodyProcessingInformationIssuer) validateDiscretionaryData(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("mitReversalRequest"+"."+"processingInformation"+"."+"issuer"+"."+"discretionaryData", "body", string(o.DiscretionaryData), 255); err != nil {
		return err
	}
...
func (o *MitReversalParamsBodyReversalInformationAmountDetails) validateCurrency(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("mitReversalRequest"+"."+"reversalInformation"+"."+"amountDetails"+"."+"currency", "body", string(o.Currency), 3); err != nil {
		return err
	}
...
func (o *MitReversalParamsBodyReversalInformationAmountDetails) validateTotalAmount(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("mitReversalRequest"+"."+"reversalInformation"+"."+"amountDetails"+"."+"totalAmount", "body", string(o.TotalAmount), 19); err != nil {
		return err
	}
