...
type ValidateAuthenticationResultsParamsBodyConsumerAuthenticationInformation struct {
	...
	// A JWT returned by 3DS provider once the authentication is complete, required in cruise hybrid integration method
	// when using CyberSource generated access token.
	//
	// Max Length: 2048
...
func (o *ValidateAuthenticationResultsParamsBodyConsumerAuthenticationInformation) Validate(formats strfmt.Registry) error {
	...
	if err := o.validateResponseAccessToken(formats); err != nil {
		res = append(res, err)
	}
...
func (o *ValidateAuthenticationResultsParamsBodyConsumerAuthenticationInformation) validateResponseAccessToken(formats strfmt.Registry) error {

	if swag.IsZero(o.ResponseAccessToken) { // not required
		return nil
	}

	if err := validate.MaxLength("validateRequest"+"."+"consumerAuthenticationInformation"+"."+"responseAccessToken", "body", string(o.ResponseAccessToken), 2048); err != nil {
		return err
	}
...
func (o *ValidateAuthenticationResultsParamsBodyPaymentInformationCustomer) validateID(formats strfmt.Registry) error {
	...
	if err := validate.MinLength("validateRequest"+"."+"paymentInformation"+"."+"customer"+"."+"id", "body", string(o.ID), 1); err != nil {
		return err
	}

	if err := validate.MaxLength("validateRequest"+"."+"paymentInformation"+"."+"customer"+"."+"id", "body", string(o.ID), 32); err != nil {
		return err
	}
