...
func (o *CheckPayerAuthEnrollmentCreatedBodyConsumerAuthenticationInformation) validateAccessToken(formats strfmt.Registry) error {

	if swag.IsZero(o.AccessToken) { // not required
		return nil
	}

	if err := validate.MaxLength("checkPayerAuthEnrollmentCreated"+"."+"consumerAuthenticationInformation"+"."+"accessToken", "body", string(o.AccessToken), 2048); err != nil {
		return err
	}
...
func (o *CheckPayerAuthEnrollmentParamsBodyConsumerAuthenticationInformation) validateReturnURL(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("checkPayerAuthEnrollmentRequest"+"."+"consumerAuthenticationInformation"+"."+"returnUrl", "body", string(o.ReturnURL), 2048); err != nil {
		return err
	}
...
func (o *CheckPayerAuthEnrollmentParamsBodyPaymentInformationCustomer) validateID(formats strfmt.Registry) error {
	...
	if err := validate.MinLength("checkPayerAuthEnrollmentRequest"+"."+"paymentInformation"+"."+"customer"+"."+"id", "body", string(o.ID), 1); err != nil {
		return err
	}

	if err := validate.MaxLength("checkPayerAuthEnrollmentRequest"+"."+"paymentInformation"+"."+"customer"+"."+"id", "body", string(o.ID), 32); err != nil {
		return err
	}
