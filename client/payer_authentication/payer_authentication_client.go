...
type ClientService interface {
	...
	PayerAuthSetup(params *PayerAuthSetupParams) (*PayerAuthSetupCreated, error)
...
*/
func (a *Client) PayerAuthSetup(params *PayerAuthSetupParams) (*PayerAuthSetupCreated, error) {
	// TODO: Validate the params before sending
	if params == nil {
