...
/*DeleteBulkP12KeysOK handles this case with default header values.
...
/*DeleteBulkP12KeysBadRequest handles this case with default header values.
...
/*DeleteBulkP12KeysBadGateway handles this case with default header values.
...
/*DeleteBulkP12KeysOKBody delete bulk p12 keys o k body
...
func (o *DeleteBulkP12KeysOKBodyClientReferenceInformation) validateCode(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("deleteBulkP12KeysOK"+"."+"clientReferenceInformation"+"."+"code", "body", string(o.Code), 50); err != nil {
		return err
	}
...
func (o *DeleteBulkP12KeysOKBodyClientReferenceInformationPartner) validateDeveloperID(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("deleteBulkP12KeysOK"+"."+"clientReferenceInformation"+"."+"partner"+"."+"developerId", "body", string(o.DeveloperID), 8); err != nil {
		return err
	}
...
func (o *DeleteBulkP12KeysOKBodyClientReferenceInformationPartner) validateSolutionID(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("deleteBulkP12KeysOK"+"."+"clientReferenceInformation"+"."+"partner"+"."+"solutionId", "body", string(o.SolutionID), 8); err != nil {
		return err
	}
...
func (o *DeleteBulkP12KeysParamsBodyClientReferenceInformation) validateCode(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("deleteBulkP12KeysRequest"+"."+"clientReferenceInformation"+"."+"code", "body", string(o.Code), 50); err != nil {
		return err
	}
...
func (o *DeleteBulkP12KeysParamsBodyClientReferenceInformationPartner) validateDeveloperID(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("deleteBulkP12KeysRequest"+"."+"clientReferenceInformation"+"."+"partner"+"."+"developerId", "body", string(o.DeveloperID), 8); err != nil {
		return err
	}
...
func (o *DeleteBulkP12KeysParamsBodyClientReferenceInformationPartner) validateSolutionID(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("deleteBulkP12KeysRequest"+"."+"clientReferenceInformation"+"."+"partner"+"."+"solutionId", "body", string(o.SolutionID), 8); err != nil {
		return err
	}
