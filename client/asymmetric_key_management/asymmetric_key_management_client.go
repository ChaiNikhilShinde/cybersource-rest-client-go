...
type ClientService interface {
	CreateP12Keys(params *CreateP12KeysParams) (*CreateP12KeysCreated, error)

	DeleteBulkP12Keys(params *DeleteBulkP12KeysParams) (*DeleteBulkP12KeysOK, error)

	GetP12KeyDetails(params *GetP12KeyDetailsParams) (*GetP12KeyDetailsOK, error)
...
*/
func (a *Client) CreateP12Keys(params *CreateP12KeysParams) (*CreateP12KeysCreated, error) {
...
*/
func (a *Client) DeleteBulkP12Keys(params *DeleteBulkP12KeysParams) (*DeleteBulkP12KeysOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) GetP12KeyDetails(params *GetP12KeyDetailsParams) (*GetP12KeyDetailsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
