...
/*CreateP12KeysCreated handles this case with default header values.
...
/*CreateP12KeysBadRequest handles this case with default header values.
...
/*CreateP12KeysBadGateway handles this case with default header values.
...
/*CreateP12KeysCreatedBody create p12 keys created body
...
func (o *CreateP12KeysCreatedBodyClientReferenceInformation) validateCode(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("createP12KeysCreated"+"."+"clientReferenceInformation"+"."+"code", "body", string(o.Code), 50); err != nil {
		return err
	}
...
func (o *CreateP12KeysCreatedBodyClientReferenceInformationPartner) validateDeveloperID(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("createP12KeysCreated"+"."+"clientReferenceInformation"+"."+"partner"+"."+"developerId", "body", string(o.DeveloperID), 8); err != nil {
		return err
	}
...
func (o *CreateP12KeysCreatedBodyClientReferenceInformationPartner) validateSolutionID(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("createP12KeysCreated"+"."+"clientReferenceInformation"+"."+"partner"+"."+"solutionId", "body", string(o.SolutionID), 8); err != nil {
		return err
	}
...
func (o *CreateP12KeysParamsBodyClientReferenceInformation) validateCode(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("createP12KeysRequest"+"."+"clientReferenceInformation"+"."+"code", "body", string(o.Code), 50); err != nil {
		return err
	}
...
func (o *CreateP12KeysParamsBodyClientReferenceInformationPartner) validateDeveloperID(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("createP12KeysRequest"+"."+"clientReferenceInformation"+"."+"partner"+"."+"developerId", "body", string(o.DeveloperID), 8); err != nil {
		return err
	}
...
func (o *CreateP12KeysParamsBodyClientReferenceInformationPartner) validateSolutionID(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("createP12KeysRequest"+"."+"clientReferenceInformation"+"."+"partner"+"."+"solutionId", "body", string(o.SolutionID), 8); err != nil {
		return err
	}
