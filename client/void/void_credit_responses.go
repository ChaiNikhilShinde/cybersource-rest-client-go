...
func (o *VoidCreditCreatedBodyProcessorInformation) validateResponseCode(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("voidCreditCreated"+"."+"processorInformation"+"."+"responseCode", "body", string(o.ResponseCode), 10); err != nil {
		return err
	}
...
func (o *VoidCreditParamsBodyClientReferenceInformationPartner) validateThirdPartyCertificationNumber(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("voidCreditRequest"+"."+"clientReferenceInformation"+"."+"partner"+"."+"thirdPartyCertificationNumber", "body", string(o.ThirdPartyCertificationNumber), 12); err != nil {
		return err
	}
