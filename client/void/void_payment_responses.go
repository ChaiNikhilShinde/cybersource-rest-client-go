...
func (o *VoidPaymentCreatedBodyProcessorInformation) validateResponseCode(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("voidPaymentCreated"+"."+"processorInformation"+"."+"responseCode", "body", string(o.ResponseCode), 10); err != nil {
		return err
	}
...
func (o *VoidPaymentParamsBodyClientReferenceInformationPartner) validateThirdPartyCertificationNumber(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("voidPaymentRequest"+"."+"clientReferenceInformation"+"."+"partner"+"."+"thirdPartyCertificationNumber", "body", string(o.ThirdPartyCertificationNumber), 12); err != nil {
		return err
	}
