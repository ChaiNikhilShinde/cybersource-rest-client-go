...
type ClientService interface {
	GetInvoiceSettings(params *GetInvoiceSettingsParams) (*GetInvoiceSettingsOK, error)

	UpdateInvoiceSettings(params *UpdateInvoiceSettingsParams) (*UpdateInvoiceSettingsOK, error)
...
*/
func (a *Client) GetInvoiceSettings(params *GetInvoiceSettingsParams) (*GetInvoiceSettingsOK, error) {
...
*/
func (a *Client) UpdateInvoiceSettings(params *UpdateInvoiceSettingsParams) (*UpdateInvoiceSettingsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
