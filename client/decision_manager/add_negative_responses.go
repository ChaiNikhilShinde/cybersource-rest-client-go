...
/*AddNegativeCreated handles this case with default header values.
...
/*AddNegativeBadRequest handles this case with default header values.
...
type AddNegativeBody struct {
	...
	// Required: true
	ClientReferenceInformation *AddNegativeParamsBodyClientReferenceInformation `json:"clientReferenceInformation"`
...
func (o *AddNegativeBody) validateClientReferenceInformation(formats strfmt.Registry) error {
	...
	if err := validate.Required("addNegativeListRequest"+"."+"clientReferenceInformation", "body", o.ClientReferenceInformation); err != nil {
		return err
	}
...
func (o *AddNegativeCreatedBody) validateID(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("addNegativeCreated"+"."+"id", "body", string(o.ID), 26); err != nil {
		return err
	}
...
func (o *AddNegativeCreatedBodyClientReferenceInformaton) validateCode(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("addNegativeCreated"+"."+"clientReferenceInformaton"+"."+"code", "body", string(o.Code), 50); err != nil {
		return err
	}
...
func (o *AddNegativeParamsBodyClientReferenceInformation) validateCode(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("addNegativeListRequest"+"."+"clientReferenceInformation"+"."+"code", "body", string(o.Code), 50); err != nil {
		return err
	}
...
func (o *AddNegativeParamsBodyClientReferenceInformation) validateComments(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("addNegativeListRequest"+"."+"clientReferenceInformation"+"."+"comments", "body", string(o.Comments), 255); err != nil {
		return err
	}
...
func (o *AddNegativeParamsBodyDeviceInformation) validateIPAddress(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("addNegativeListRequest"+"."+"deviceInformation"+"."+"ipAddress", "body", string(o.IPAddress), 48); err != nil {
		return err
	}
...
func (o *AddNegativeParamsBodyDeviceInformation) validateNetworkIPAddress(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("addNegativeListRequest"+"."+"deviceInformation"+"."+"networkIpAddress", "body", string(o.NetworkIPAddress), 11); err != nil {
		return err
	}
...
func (o *AddNegativeParamsBodyOrderInformationAddress) validateAddress1(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("addNegativeListRequest"+"."+"orderInformation"+"."+"address"+"."+"address1", "body", string(o.Address1), 60); err != nil {
		return err
	}
...
func (o *AddNegativeParamsBodyOrderInformationAddress) validateAddress2(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("addNegativeListRequest"+"."+"orderInformation"+"."+"address"+"."+"address2", "body", string(o.Address2), 60); err != nil {
		return err
	}
...
func (o *AddNegativeParamsBodyOrderInformationAddress) validateAdministrativeArea(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("addNegativeListRequest"+"."+"orderInformation"+"."+"address"+"."+"administrativeArea", "body", string(o.AdministrativeArea), 2); err != nil {
		return err
	}
...
func (o *AddNegativeParamsBodyOrderInformationAddress) validateCountry(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("addNegativeListRequest"+"."+"orderInformation"+"."+"address"+"."+"country", "body", string(o.Country), 2); err != nil {
		return err
	}
...
func (o *AddNegativeParamsBodyOrderInformationAddress) validateLocality(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("addNegativeListRequest"+"."+"orderInformation"+"."+"address"+"."+"locality", "body", string(o.Locality), 50); err != nil {
		return err
	}
...
func (o *AddNegativeParamsBodyOrderInformationAddress) validatePostalCode(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("addNegativeListRequest"+"."+"orderInformation"+"."+"address"+"."+"postalCode", "body", string(o.PostalCode), 10); err != nil {
		return err
	}
...
func (o *AddNegativeParamsBodyOrderInformationBillTo) validateAddress1(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("addNegativeListRequest"+"."+"orderInformation"+"."+"billTo"+"."+"address1", "body", string(o.Address1), 60); err != nil {
		return err
	}
...
func (o *AddNegativeParamsBodyOrderInformationBillTo) validateAddress2(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("addNegativeListRequest"+"."+"orderInformation"+"."+"billTo"+"."+"address2", "body", string(o.Address2), 60); err != nil {
		return err
	}
...
func (o *AddNegativeParamsBodyOrderInformationBillTo) validateAdministrativeArea(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("addNegativeListRequest"+"."+"orderInformation"+"."+"billTo"+"."+"administrativeArea", "body", string(o.AdministrativeArea), 20); err != nil {
		return err
	}
...
func (o *AddNegativeParamsBodyOrderInformationBillTo) validateCountry(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("addNegativeListRequest"+"."+"orderInformation"+"."+"billTo"+"."+"country", "body", string(o.Country), 2); err != nil {
		return err
	}
...
func (o *AddNegativeParamsBodyOrderInformationBillTo) validateEmail(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("addNegativeListRequest"+"."+"orderInformation"+"."+"billTo"+"."+"email", "body", string(o.Email), 255); err != nil {
		return err
	}
...
func (o *AddNegativeParamsBodyOrderInformationBillTo) validateEmailDomain(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("addNegativeListRequest"+"."+"orderInformation"+"."+"billTo"+"."+"emailDomain", "body", string(o.EmailDomain), 100); err != nil {
		return err
	}
...
func (o *AddNegativeParamsBodyOrderInformationBillTo) validateFirstName(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("addNegativeListRequest"+"."+"orderInformation"+"."+"billTo"+"."+"firstName", "body", string(o.FirstName), 60); err != nil {
		return err
	}
...
func (o *AddNegativeParamsBodyOrderInformationBillTo) validateLastName(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("addNegativeListRequest"+"."+"orderInformation"+"."+"billTo"+"."+"lastName", "body", string(o.LastName), 60); err != nil {
		return err
	}
...
func (o *AddNegativeParamsBodyOrderInformationBillTo) validateLocality(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("addNegativeListRequest"+"."+"orderInformation"+"."+"billTo"+"."+"locality", "body", string(o.Locality), 50); err != nil {
		return err
	}
...
func (o *AddNegativeParamsBodyOrderInformationBillTo) validatePhoneNumber(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("addNegativeListRequest"+"."+"orderInformation"+"."+"billTo"+"."+"phoneNumber", "body", string(o.PhoneNumber), 15); err != nil {
		return err
	}
...
func (o *AddNegativeParamsBodyOrderInformationBillTo) validatePostalCode(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("addNegativeListRequest"+"."+"orderInformation"+"."+"billTo"+"."+"postalCode", "body", string(o.PostalCode), 10); err != nil {
		return err
	}
...
func (o *AddNegativeParamsBodyOrderInformationShipTo) validateAddress1(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("addNegativeListRequest"+"."+"orderInformation"+"."+"shipTo"+"."+"address1", "body", string(o.Address1), 60); err != nil {
		return err
	}
...
func (o *AddNegativeParamsBodyOrderInformationShipTo) validateAddress2(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("addNegativeListRequest"+"."+"orderInformation"+"."+"shipTo"+"."+"address2", "body", string(o.Address2), 60); err != nil {
		return err
	}
...
func (o *AddNegativeParamsBodyOrderInformationShipTo) validateAdministrativeArea(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("addNegativeListRequest"+"."+"orderInformation"+"."+"shipTo"+"."+"administrativeArea", "body", string(o.AdministrativeArea), 2); err != nil {
		return err
	}
...
func (o *AddNegativeParamsBodyOrderInformationShipTo) validateCountry(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("addNegativeListRequest"+"."+"orderInformation"+"."+"shipTo"+"."+"country", "body", string(o.Country), 2); err != nil {
		return err
	}
...
func (o *AddNegativeParamsBodyOrderInformationShipTo) validateLocality(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("addNegativeListRequest"+"."+"orderInformation"+"."+"shipTo"+"."+"locality", "body", string(o.Locality), 50); err != nil {
		return err
	}
...
func (o *AddNegativeParamsBodyOrderInformationShipTo) validatePostalCode(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("addNegativeListRequest"+"."+"orderInformation"+"."+"shipTo"+"."+"postalCode", "body", string(o.PostalCode), 10); err != nil {
		return err
	}
...
func (o *AddNegativeParamsBodyPaymentInformationBank) validateAccountNumber(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("addNegativeListRequest"+"."+"paymentInformation"+"."+"bank"+"."+"accountNumber", "body", string(o.AccountNumber), 30); err != nil {
		return err
	}
...
func (o *AddNegativeParamsBodyPaymentInformationBank) validateCode(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("addNegativeListRequest"+"."+"paymentInformation"+"."+"bank"+"."+"code", "body", string(o.Code), 15); err != nil {
		return err
	}
...
func (o *AddNegativeParamsBodyPaymentInformationBank) validateCountry(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("addNegativeListRequest"+"."+"paymentInformation"+"."+"bank"+"."+"country", "body", string(o.Country), 2); err != nil {
		return err
	}
...
func (o *AddNegativeParamsBodyPaymentInformationBank) validateIban(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("addNegativeListRequest"+"."+"paymentInformation"+"."+"bank"+"."+"iban", "body", string(o.Iban), 30); err != nil {
		return err
	}
...
func (o *AddNegativeParamsBodyPaymentInformationCard) validateBin(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("addNegativeListRequest"+"."+"paymentInformation"+"."+"card"+"."+"bin", "body", string(o.Bin), 6); err != nil {
		return err
	}
...
func (o *AddNegativeParamsBodyPaymentInformationCard) validateNumber(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("addNegativeListRequest"+"."+"paymentInformation"+"."+"card"+"."+"number", "body", string(o.Number), 20); err != nil {
		return err
	}
...
func (o *AddNegativeParamsBodyRiskInformationMarkingDetails) validateNotes(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("addNegativeListRequest"+"."+"riskInformation"+"."+"markingDetails"+"."+"notes", "body", string(o.Notes), 120); err != nil {
		return err
	}
...
func (o *AddNegativeParamsBodyRiskInformationMarkingDetails) validateReason(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("addNegativeListRequest"+"."+"riskInformation"+"."+"markingDetails"+"."+"reason", "body", string(o.Reason), 25); err != nil {
		return err
	}
...
func (o *AddNegativeParamsBodyRiskInformationMarkingDetails) validateRecordName(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("addNegativeListRequest"+"."+"riskInformation"+"."+"markingDetails"+"."+"recordName", "body", string(o.RecordName), 255); err != nil {
		return err
	}
