...
/*DeleteCustomerGone handles this case with default header values.
...
/*DeleteCustomerFailedDependency handles this case with default header values.
...
/*DeleteCustomerInternalServerError handles this case with default header values.
