...
/*CreateV2SharedSecretKeysCreated handles this case with default header values.
...
/*CreateV2SharedSecretKeysBadRequest handles this case with default header values.
...
/*CreateV2SharedSecretKeysBadGateway handles this case with default header values.
...
/*CreateV2SharedSecretKeysCreatedBody create v2 shared secret keys created body
...
func (o *CreateV2SharedSecretKeysCreatedBodyClientReferenceInformation) validateCode(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("createV2SharedSecretKeysCreated"+"."+"clientReferenceInformation"+"."+"code", "body", string(o.Code), 50); err != nil {
		return err
	}
...
func (o *CreateV2SharedSecretKeysCreatedBodyClientReferenceInformationPartner) validateDeveloperID(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("createV2SharedSecretKeysCreated"+"."+"clientReferenceInformation"+"."+"partner"+"."+"developerId", "body", string(o.DeveloperID), 8); err != nil {
		return err
	}
...
func (o *CreateV2SharedSecretKeysCreatedBodyClientReferenceInformationPartner) validateSolutionID(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("createV2SharedSecretKeysCreated"+"."+"clientReferenceInformation"+"."+"partner"+"."+"solutionId", "body", string(o.SolutionID), 8); err != nil {
		return err
	}
...
func (o *CreateV2SharedSecretKeysParamsBodyClientReferenceInformation) validateCode(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("createSharedSecretKeysRequest"+"."+"clientReferenceInformation"+"."+"code", "body", string(o.Code), 50); err != nil {
		return err
	}
...
func (o *CreateV2SharedSecretKeysParamsBodyClientReferenceInformationPartner) validateDeveloperID(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("createSharedSecretKeysRequest"+"."+"clientReferenceInformation"+"."+"partner"+"."+"developerId", "body", string(o.DeveloperID), 8); err != nil {
		return err
	}
...
func (o *CreateV2SharedSecretKeysParamsBodyClientReferenceInformationPartner) validateSolutionID(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("createSharedSecretKeysRequest"+"."+"clientReferenceInformation"+"."+"partner"+"."+"solutionId", "body", string(o.SolutionID), 8); err != nil {
		return err
	}
