...
/*DeleteBulkSymmetricKeysOK handles this case with default header values.
...
/*DeleteBulkSymmetricKeysBadRequest handles this case with default header values.
...
/*DeleteBulkSymmetricKeysBadGateway handles this case with default header values.
...
/*DeleteBulkSymmetricKeysOKBody delete bulk symmetric keys o k body
...
func (o *DeleteBulkSymmetricKeysOKBodyClientReferenceInformation) validateCode(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("deleteBulkSymmetricKeysOK"+"."+"clientReferenceInformation"+"."+"code", "body", string(o.Code), 50); err != nil {
		return err
	}
...
func (o *DeleteBulkSymmetricKeysOKBodyClientReferenceInformationPartner) validateDeveloperID(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("deleteBulkSymmetricKeysOK"+"."+"clientReferenceInformation"+"."+"partner"+"."+"developerId", "body", string(o.DeveloperID), 8); err != nil {
		return err
	}
...
func (o *DeleteBulkSymmetricKeysOKBodyClientReferenceInformationPartner) validateSolutionID(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("deleteBulkSymmetricKeysOK"+"."+"clientReferenceInformation"+"."+"partner"+"."+"solutionId", "body", string(o.SolutionID), 8); err != nil {
		return err
	}
...
func (o *DeleteBulkSymmetricKeysParamsBodyClientReferenceInformation) validateCode(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("deleteBulkSymmetricKeysRequest"+"."+"clientReferenceInformation"+"."+"code", "body", string(o.Code), 50); err != nil {
		return err
	}
...
func (o *DeleteBulkSymmetricKeysParamsBodyClientReferenceInformationPartner) validateDeveloperID(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("deleteBulkSymmetricKeysRequest"+"."+"clientReferenceInformation"+"."+"partner"+"."+"developerId", "body", string(o.DeveloperID), 8); err != nil {
		return err
	}
...
func (o *DeleteBulkSymmetricKeysParamsBodyClientReferenceInformationPartner) validateSolutionID(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("deleteBulkSymmetricKeysRequest"+"."+"clientReferenceInformation"+"."+"partner"+"."+"solutionId", "body", string(o.SolutionID), 8); err != nil {
		return err
	}
