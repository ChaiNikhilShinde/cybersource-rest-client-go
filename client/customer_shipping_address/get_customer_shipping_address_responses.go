...
/*GetCustomerShippingAddressOK handles this case with default header values.
...
/*GetCustomerShippingAddressBadRequest handles this case with default header values.
...
/*GetCustomerShippingAddressNotFound handles this case with default header values.
...
/*GetCustomerShippingAddressGone handles this case with default header values.
...
/*GetCustomerShippingAddressFailedDependency handles this case with default header values.
...
/*GetCustomerShippingAddressInternalServerError handles this case with default header values.
...
func (o *GetCustomerShippingAddressOKBody) validateID(formats strfmt.Registry) error {
	...
	if err := validate.MinLength("getCustomerShippingAddressOK"+"."+"id", "body", string(o.ID), 1); err != nil {
		return err
	}

	if err := validate.MaxLength("getCustomerShippingAddressOK"+"."+"id", "body", string(o.ID), 32); err != nil {
		return err
	}
...
func (o *GetCustomerShippingAddressOKBodyShipTo) validateAddress1(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("getCustomerShippingAddressOK"+"."+"shipTo"+"."+"address1", "body", string(o.Address1), 60); err != nil {
		return err
	}
...
func (o *GetCustomerShippingAddressOKBodyShipTo) validateAddress2(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("getCustomerShippingAddressOK"+"."+"shipTo"+"."+"address2", "body", string(o.Address2), 60); err != nil {
		return err
	}
...
func (o *GetCustomerShippingAddressOKBodyShipTo) validateAdministrativeArea(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("getCustomerShippingAddressOK"+"."+"shipTo"+"."+"administrativeArea", "body", string(o.AdministrativeArea), 20); err != nil {
		return err
	}
...
func (o *GetCustomerShippingAddressOKBodyShipTo) validateCompany(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("getCustomerShippingAddressOK"+"."+"shipTo"+"."+"company", "body", string(o.Company), 60); err != nil {
		return err
	}
...
func (o *GetCustomerShippingAddressOKBodyShipTo) validateCountry(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("getCustomerShippingAddressOK"+"."+"shipTo"+"."+"country", "body", string(o.Country), 2); err != nil {
		return err
	}
...
func (o *GetCustomerShippingAddressOKBodyShipTo) validateEmail(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("getCustomerShippingAddressOK"+"."+"shipTo"+"."+"email", "body", string(o.Email), 320); err != nil {
		return err
	}
...
func (o *GetCustomerShippingAddressOKBodyShipTo) validateFirstName(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("getCustomerShippingAddressOK"+"."+"shipTo"+"."+"firstName", "body", string(o.FirstName), 60); err != nil {
		return err
	}
...
func (o *GetCustomerShippingAddressOKBodyShipTo) validateLastName(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("getCustomerShippingAddressOK"+"."+"shipTo"+"."+"lastName", "body", string(o.LastName), 60); err != nil {
		return err
	}
...
func (o *GetCustomerShippingAddressOKBodyShipTo) validateLocality(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("getCustomerShippingAddressOK"+"."+"shipTo"+"."+"locality", "body", string(o.Locality), 50); err != nil {
		return err
	}
...
func (o *GetCustomerShippingAddressOKBodyShipTo) validatePhoneNumber(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("getCustomerShippingAddressOK"+"."+"shipTo"+"."+"phoneNumber", "body", string(o.PhoneNumber), 15); err != nil {
		return err
	}
...
func (o *GetCustomerShippingAddressOKBodyShipTo) validatePostalCode(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("getCustomerShippingAddressOK"+"."+"shipTo"+"."+"postalCode", "body", string(o.PostalCode), 10); err != nil {
		return err
	}
